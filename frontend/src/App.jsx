...
<<<<<<< HEAD
  ...
  const getMessage = (e) => ({
    happy: 'Keep shining bright!',
    sad: "It's okay, better days ahead.",
    angry: 'Take a deep breath.',
    neutral: 'Staying balanced.',
    surprised: 'What a moment!',
    fearful: 'You are safe here.'
  }[e] || '');
      ...
      <div className="body">
        ...
        <div className="col-left">
          ...
          <p className="hero-sub">
            Record your voice to analyze your emotional state.
          </p>

          <div className="card recorder-card">

            <h2 className="card-title">
              Voice Emotion Recorder
            </h2>
          ...
          <div className="card emotion-card">
            ...
            {currentEmotion ? (
              ...
              <>
                ...
                <p className="emotion-msg">
                  {getMessage(currentEmotion)}
                </p>
              </>
          ...
          <div className="card chart-card">
            ...
            {history.length > 0 ? (
              ...
              <p className="chart-empty">
                Record audio to see your mood trend.
              </p>
            )}
